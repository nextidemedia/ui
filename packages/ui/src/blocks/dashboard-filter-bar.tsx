...
function DashboardFilterBar({
  ...
  const { canScrollLeft, canScrollRight, updateLayout } =
    useDashboardFilterLayout(
      scrollerRef,
      sliderRef,
      effectLayerRef,
      activeGroupId,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FilterActions hasSelection={hasSelection} onClear={onClear} />
      </div>
    </section>
  )
}
...
function FilterSlider({
  ...
  updateLayout: () => void
  visibleItems: DashboardFilterItem[]
...
function FilterScope({
  ...
  groups: DashboardFilterGroup[]
  items: DashboardFilterItem[]
  activeGroup: DashboardFilterGroup | undefined
}) {
  return (
    <div
    ...
    >
      <span className="flex min-w-0 items-start justify-between gap-2">
        ...
        {item.badge || item.live ? (
          <StatusBadge
            tone={item.tone ?? (item.live ? "success" : "neutral")}
...
function useDashboardFilterLayout(
  scrollerRef: React.RefObject<HTMLDivElement | null>,
  sliderRef: React.RefObject<HTMLDivElement | null>,
  effectLayerRef: React.RefObject<HTMLDivElement | null>,
  activeGroupId: string,
  selectedItemId: string | undefined,
  ...
  }, [scrollerRef, sliderRef, effectLayerRef])
  ...
  return { canScrollLeft, canScrollRight, updateLayout }
}
