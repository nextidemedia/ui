...
| Identity and feedback      | `components/avatar`, `components/empty`, `components/progress`, `components/processing-text`, `components/scramble-text`, `components/spinner`, `components/skeleton`                                                                                                                                                                                                                             |
